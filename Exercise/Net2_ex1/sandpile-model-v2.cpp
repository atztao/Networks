...
int main()
{
    ...
    int sandpile_A[50][50],sandpile_B[50][50];
    ...
    for (int Add = 0; Add < 1000000; Add++) {
        ...
        sandpile_x = random(0,49); // [a,b] rand()%(b-a+1)+a；
        sandpile_y = random(0,49);
        ...
        //弛豫时间T
        for (unsigned long T = 0; T < 50000000000000; T++) { 
            //判断是否存在雪崩Number == 500则不存在否则有
            int Number = 0;
